...
public class ErrorHandlingTest extends BaseIntegrationTest {
	...
	// TODO - Check how to specifically do not wait with PaxExam
	...
	public void testErrorHandling() throws Exception {
		Bundle errorBundle = OsgiBundleUtils.findBundleBySymbolicName(bundleContext, "org.eclipse.gemini.blueprint.iandt.error");

		assertNotNull("Error bundle exists", errorBundle);
